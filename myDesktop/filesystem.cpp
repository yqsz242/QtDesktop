...
void fileSystem::isSelected(const QModelIndex& current,const QModelIndex& previous)
{
...
void fileSystem::updateListModel(QStringList& dirName,QStringList& fileName,QDir& dir)
{
...
void fileSystem::chooseMode(int i)
{
    if(i==0)
    {
        ui->tableView->hide();
...
void fileSystem::on_action_Quit_triggered()
{
    this->close();
}
void fileSystem::changeIndex(QModelIndex index)
{
...
void fileSystem::detail(QModelIndex index)
{
...
void fileSystem::on_action_dis_triggered()
{
...
void fileSystem::on_Proper_triggered()
{
    QString string=this->lineEdit->text();
