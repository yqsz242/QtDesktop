...
//Button *x1yButton = createButton(tr("x^y"), SLOT(additiveOperatorClicked()));
//Button *xsButton = createButton(tr("+"), SLOT(additiveOperatorClicked()));
//Button *plusButton = createButton(tr("+"), SLOT(additiveOperatorClicked()));
...
Button *x2Button = createButton(tr("x2"), SLOT(unaryOperatorClicked()));
Button *x3Button = createButton(tr("x3"), SLOT(unaryOperatorClicked()));
Button *nButton = createButton(tr("n"), SLOT(unaryOperatorClicked()));
Button *x03Button = createButton(tr("x03"), SLOT(unaryOperatorClicked()));
Button *x10Button = createButton(tr("x10"), SLOT(unaryOperatorClicked()));
...
//! [5] //! [6]
    ...
    mainLayout->addWidget(sinButton, 6, 6);
    mainLayout->addWidget(cosButton, 5, 6);
    mainLayout->addWidget(tanButton, 4, 6);
mainLayout->addWidget(x2Button,1,7);
mainLayout->addWidget(x3Button ,2,7);
mainLayout->addWidget(nButton ,3,7);
mainLayout->addWidget(x03Button ,4,7);
mainLayout->addWidget(x10Button ,5,7);
mainLayout->addWidget(logButton ,6,7);
...
Button *logButton = createButton(tr("log"), SLOT(unaryOperatorClicked()));
*/
else if(clickedOperator == tr("x2"))
	{
result = operand*operand;
}
else if(clickedOperator == tr("x3"))
	{
